...
::: {.callout-note}
Esta ruta de la guía está adaptada del trabajo de **Juan Felipe García**, Country Director de IPA Colombia, quien construyó un workspace personal con Claude Code durante 3 meses y documentó las herramientas y plantillas que creó. La versión original en MkDocs vive en [juanfegarIPA/claude-code-ipa-colombia](https://github.com/juanfegarIPA/claude-code-ipa-colombia).
:::
